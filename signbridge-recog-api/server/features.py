# Vendored verbatim from BioCode67/signbridge ml/signbridge/features.py (commit 79bbd65).
# Do not edit here — keep numerically identical to src/recognition/landmarks.ts.
"""랜드마크 → 고정 차원 특징 벡터.
